...
import { PlacingAnOrederStackParamList } from "../../../../navigation/placing-an-order/placing-an-order-navigation";

type PlacingAnOrderAddAddressDeliveryProps = {
  route: RouteProp<
...
const PlacingAnOrderAddAddressDelivery: FC<PlacingAnOrderAddAddressDeliveryProps> =
  ({ route }) => {
    ...
    const [validationEntrance, setValidationEntrance] =
      useState<boolean>(false);
...
export default PlacingAnOrderAddAddressDelivery;
