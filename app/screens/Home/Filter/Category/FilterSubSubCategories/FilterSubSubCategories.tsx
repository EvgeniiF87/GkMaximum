...
type FilterSubSubCategoriesProps = {
  route: RouteProp<AppStackParamList, "FilterSubSubCategories">;
};

const FilterSubSubCategories: FC<FilterSubSubCategoriesProps> = ({ route }) => {
...
export default FilterSubSubCategories;
